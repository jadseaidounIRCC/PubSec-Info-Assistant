...
ENV = {
    "AZURE_BLOB_STORAGE_ACCOUNT": "irccgptstorage",
    "USE_AZURE_OPENAI_EMBEDDINGS": False,
    "AZURE_BLOB_STORAGE_ENDPOINT": "https://irccgptstorage.blob.core.windows.net/",
    "AZURE_BLOB_STORAGE_CONTAINER": "content",
    "AZURE_BLOB_STORAGE_UPLOAD_CONTAINER": "upload",
    "AZURE_SEARCH_SERVICE": "irccgptvectorsearch",
    "AZURE_SEARCH_SERVICE_ENDPOINT": "https://irccgptvectorsearch.search.windows.net",
    "AZURE_SEARCH_INDEX": "agent-irpa-index",
    "AZURE_SEARCH_AUDIENCE": "",
    "USE_SEMANTIC_RERANKER": "true",
    "AZURE_OPENAI_SERVICE": "OpaiDevEast",
    "AZURE_OPENAI_RESOURCE_GROUP": "RG-LS-Dev",
    "AZURE_OPENAI_ENDPOINT": "https://opaideveast.openai.azure.com/",
    ...
    "COSMOSDB_URL": "https://new-info-assistant-cosmos.documents.azure.com:443/",
    "COSMOSDB_LOG_DATABASE_NAME": "myDatabase",
    "COSMOSDB_LOG_CONTAINER_NAME": "myContainer",
